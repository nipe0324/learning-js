...
export const setMainPhoto = photo =>
  async (dispatch, getState) => {
    ...
    let eventAttendeeeRef = firestore.collection('event_attendee');
    try {
      ...
      let eventQuery = await eventAttendeeeRef.where('userUid', '==', user.uid).where('eventDate', '>', today);
...
export const cancelGoingToEvent = (event) =>
  async (dispatch, getState, { getFirestore }) => {
    ...
    try {
      ...
      await firestore.delete(`events_attendee/${event.id}_${user.uid}`);
...
export const followUser = (userToFollow) =>
  async (dispatch, getState, { getFirestore }) => {
    ...
    try {
      ...
      console.log(error);
      toastr.error('Oops', 'Problem follow user');
    }
  }
...
export const unfollowUser = (userToUnfollow) =>
  async (dispatch, getState, { getFirestore }) => {
    ...
    try {
      ...
      console.log(error);
      toastr.error('Oops', 'Problem unfollow user');
    }
  }
